module PaginationHelper
  def pager(pagination, current_page = 1)
    ...
    if pagination.total_pages <= 10
      ...
      displayed_pages_upper_bound = pagination.total_pages;
    else
    ...
    data = {
      ...
      displayed_items_upper_bound: current_page * pagination.per_page > pagination.total_items ? pagination.total_items : current_page * pagination.per_page,
